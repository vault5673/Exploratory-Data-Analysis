...
This project focuses on cleaning, preprocessing, and performing exploratory data analysis (EDA) on the famous Titanic dataset. It uses statistical visualizations and techniques to extract meaningful insights from passenger data.
